    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-primary">
                ...
                <li class="nav-item <?php echo e((request()->is('listAll')) || (request()->is('cadStudent')) || (request()->routeIs('consult')) || (request()->routeIs('editConsStudent')) || (request()->routeIs('searchDelete')) || (request()->routeIs('pdf'))  ? 'active' : ''); ?>">
                    <a data-toggle="collapse" aria-expanded="false" aria-controls="collapseOne" href="#base">
                        <i class="fas fa-users"></i>
                        <p>Alunos</p>
                        <span class="caret"></span>
                    </a>
                    <div class="expandable collapse <?php echo e((request()->routeIs('cadStudent')) || (request()->routeIs('listAll')) || (request()->routeIs('consult')) || (request()->routeIs('editConsStudent')) || (request()->routeIs('searchDelete')) || (request()->routeIs('pdf')) ? 'show' : ''); ?>"
                        ...
                        <ul class="nav nav-collapse ">
                            ...
                            <li class="<?php echo e((request()->routeIs('pdf')) ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('listAll')); ?>">
                ...
                <li class="nav-item <?php echo e((request()->Is('cadastrarTurma')) || (request()->is('listClass')) || (request()->is('consultClass')) || (request()->is('editConsClass')) || (request()->is('searchClassDelete')) ? 'active' : ''); ?>">
                    <a data-toggle="collapse" href="#sidebarLayouts2">
                        <i class="fas fa-bed" actived></i>
                        <p>Turmas</p>
                        <span class="caret"></span>
                    </a>
                    <div class="expandable collapse <?php echo e((request()->Is('cadastrarTurma')) || (request()->is('listClass')) || (request()->is('consultClass')) || (request()->is('editConsClass')) || (request()->is('searchClassDelete')) ? 'show' : ''); ?>" id="sidebarLayouts2">
                        <ul class="nav nav-collapse">
...
<!-- End Sidebar -->
<?php /**PATH C:\xampp\htdocs\modeloLeiaute-master\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>