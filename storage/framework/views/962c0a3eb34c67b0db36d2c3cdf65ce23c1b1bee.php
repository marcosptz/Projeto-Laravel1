...
<body>
    <div>
        ...
        <div class="conteudo">
            ...
            <a href="<?php echo e(route('listUser')); ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Auditar usuários</a>
...
<?php /**PATH C:\xampp\htdocs\projeto-laravel\resources\views/formHome.blade.php ENDPATH**/ ?>