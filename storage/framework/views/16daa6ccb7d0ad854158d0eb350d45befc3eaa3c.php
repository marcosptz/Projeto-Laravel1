...
<body>
    ...
    <div class="conteudo">
        ...
        <form action="<?php echo e(route('resultClass')); ?>" method="post" class="form-inline">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\projeto-laravel-1\resources\views/forms/formConsultClass.blade.php ENDPATH**/ ?>