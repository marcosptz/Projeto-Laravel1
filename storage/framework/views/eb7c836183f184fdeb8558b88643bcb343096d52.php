...
<body>
    ...
    <div class="conteudo">
        ...
        <form action="<?php echo e(route('editClass')); ?>" method="post" class="form-inline">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\modeloLeiaute-master\resources\views/formConsEditClass.blade.php ENDPATH**/ ?>